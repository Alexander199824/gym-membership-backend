// scripts/verify-oauth-config.js - Script para verificar configuración OAuth
...
const main = () => {
  console.log('🔧 VERIFICADOR DE CONFIGURACIÓN GOOGLE OAUTH');
  console.log('============================================\n');
...
module.exports = { checkGoogleOAuthConfig, checkPassportConfig };