// src/middleware/authorization.js - MEJORA PEQUEÑA
...
const authorizeClientOwnData = (req, res, next) => {
  ...
  // ✅ NUEVA LÓGICA: Si es colaborador, permitir acceso a datos de pagos/usuarios
  if (user.role === 'colaborador') {
    // Para colaboradores, permitir acceso pero será filtrado en el controller
    console.log('✅ Access granted: Collaborator user - will be filtered in controller');
    return next();
  }
